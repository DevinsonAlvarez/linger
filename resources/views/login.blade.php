...
<body class="flex justify-center items-center min-h-screen">
    <section class="flex min-h-screen items-center justify-center">
        <div class="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
            ...
            <form action="{{ route('iniciar-sesion') }}" action="post" class="mt-4 mb-2 w-80 max-w-screen-lg sm:w-96">
            ...
            <p class="text-sm text-center text-gray-700 py-1">
                This site is made by JeanP78
            </p>
        </div>
