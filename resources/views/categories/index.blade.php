...
@section('content')
    ...
    <div class="flex min-h-screen relative bg-gray-200 text-gray-800">
        <div class="p-4 w-full">
            <div class="bg-white items-center px-6 py-3 justify-between rounded-lg flex mb-4 ">
                ...
                <div x-data="{ open: false }">
                    <button @click=" open = true " class="bg-green-600 text-white px-2 py-2 rounded-lg">Agregar
                        categoría</button>
                    <div class="h-[calc(100vh-64px)] w-[calc(100vw-334px)]  top-0 left-0 bg-black/10 absolute flex justify-center items-center"
                        ...
                        <div class="bg-white w-1/3 relative -top-20 p-4 m-auto rounded-md">
                            ...
                            <h1 class="text-2xl text-center font-semibold border-b pb-2 mb-2 ">Agregar categoría</h1>
                ...
                <div class="h-[calc(100vh-64px)] w-[calc(100vw-334px)]  top-0 left-0 bg-black/10 absolute flex justify-center items-center"
                    ...
                    <div class="bg-white w-1/3 relative -top-20 p-4 m-auto rounded-md">
                        ...
                        <form {{-- :action="route" --}} method="POST">
                            ...
                            @method('PATCH')
                            <label class="font-semibold">Nombre</label>
                            <input name="name" x-model="category.name"
                                class="block border rounded-lg w-full py-1 px-3 mb-3" type="text">
                            <button type="submit"
